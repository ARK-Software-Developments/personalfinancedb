...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_update_bills` AFTER UPDATE ON `bills` FOR EACH ROW BEGIN
    INSERT INTO `logs` (`dateprocess`, `type`, `code`, `message`)
    VALUES (NOW(), 'update_bills', 1, 

CONCAT(
            'Registro actualizado en bills. ',
            'ID: ', OLD.id, ', ',
            'summary: ', OLD.summary, ', ',
